...
public abstract class EvokerMixin extends SpellcastingIllagerEntity implements IllagerClothing {
    ...
    protected EvokerMixin(EntityType<? extends SpellcastingIllagerEntity> entityType_1, World world_1) {
    ...
    private static final Identifier npcvariety$TROUSERS_TEXTURE = new Identifier("npcvariety:textures/entity/illager/trousers/evoker.png");
    ...
    private static final Identifier npcvariety$OVERCLOTHES_TEXTURE = new Identifier("npcvariety:textures/entity/illager/overclothes/robe.png");
    ...
    @Override
    public Identifier npcvariety$getShirtTexture(){
        return npcvariety$SHIRT_TEXTURE;
    }
    @Override
    public Identifier npcvariety$getOverclothesTexture(){
        return npcvariety$OVERCLOTHES_TEXTURE;
    }
    @Override
